...
- [О проекте](#о-проекте)
- [Скриншоты реализованного сайта](#скриншоты-реализованного-сайта)
...
Проект выполнен в рамках дипломной работы по специальности **09.02.07 «Информационные системы и программирование»**.
...
![Галерея](docs/admin-gallery.png)
![Отзывы](docs/admin-reviews.png)
...
```bash
git clone https://github.com/IvanKunets/foto-son-laravel.git
cd foto-son
composer install
npm install
